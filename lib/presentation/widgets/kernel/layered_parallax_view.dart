...
class LayeredParallaxView extends StatefulWidget {
  ...
  ///
  /// 单位与 [amount] 相同（逻辑像素）。取 1.5 → 主体内部起伏约 ±0.75px。
  ///
  /// ★ 为什么"以前不敢、现在敢"
  ...
  ///   所以可以启用 —— 但幅度必须小。
  ///
  /// ⚠️ 幅度经验：别取大。早期的 6（±3px）做出的是【液化揉搓】而不是立体 ——
  ///    位移场随晃动方向整体翻转，主体在晃动过程中被来回拉扯，实测反馈
  ///    "主体在镜头晃动时那种扭曲感做的很不自然"。物理上主体内部（鼻梁 vs
  ///    耳朵）的视差差只有约 0.8px，1.5 已略高于它、又远低于可见形变阈值。
  final double relief;
